	...
	<head>
		...
		<script type="text/javascript">
			...
			function doAssociations(){
				...
				if(rows.length != 1){
					//3.未选中，提示客户选择一条数据
					$.messager.alert('提示信息','请您选择一个定区!','warning');
				} else {
					id = rows[0].id;
					//4.选中一条，打开窗口
					$('#customerWindow').window('open');
					//5.发送ajax查询未关联定区(fixedAreaId is null)的客户，转换成json，回显到左边的下拉框
					...
					//5.发送ajax查询关联选中定区(fixedAreaId = ?1)的客户，转换成json，回显到右边的下拉框
					url = "${pageContext.request.contextPath}/fixedareaAction_findGuanLianCustomers.action";
					//5.1清空下拉框原有选项
