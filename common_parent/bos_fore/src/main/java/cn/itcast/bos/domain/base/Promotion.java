...
public class Promotion implements Serializable {
	...
	public String getDescription() {
		//1.判断descript是否是以<img src="/bos_management_web开头
		if(description.startsWith("<img src=\"/bos_management_web")){
			//2.如果是，将<img src="/bos_management_web替换成<img src="http://localhost:8080/bos_management_web
			return description.replace("<img src=\"/bos_management_web", "<img src=\"http://localhost:8080/bos_management_web");
		}
		//3.如果不是，直接返回description
		return description;
	}
