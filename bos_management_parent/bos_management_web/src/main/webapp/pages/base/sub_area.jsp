...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			//导出按钮绑定的事件
			function doExport(){
				//1.ajax天生不支持文件下载，使用location.href发送导出分区请求
		...
		<div class="easyui-window" title="分区添加修改" id="addWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
			<div style="height:31px;overflow:hidden;" split="false" border="false">
				<div class="datagrid-toolbar">
					...
					$(function(){
						$('#save').click(function(){
							var b = $('#subareaForm').form('validate');
							if(b){
								$('#subareaForm').submit();
							}
						});
				...
				<form id="subareaForm" method="post" action="${pageContext.request.contextPath}/subareaAction_save.action">
					<table class="table-edit" width="80%" align="center">
						...
						<tr>
							<td>分区编号</td>
							<td>
								<input type="text" class="easyui-validatebox" required=true name="id" />
							</td>
						</tr>
						<tr>
							<td>选择区域</td>
